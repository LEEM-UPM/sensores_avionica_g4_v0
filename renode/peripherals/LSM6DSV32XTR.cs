...
{
    public class LSM6DSV32XTR : II2CPeripheral, IProvidesRegisterCollection<ByteRegisterCollection>, ITemperatureSensor
    {
        public LSM6DSV32XTR()
        {
            IRQ = new GPIO();
        ...
        {
            Registers.WhoAmI.Define(RegistersCollection, 0x6B).WithTag("WHO_AM_I", 0, 8);
            ...
            Registers.Ctrl3C.Define(RegistersCollection, 0x04).WithValueField(0, 8, name: "CTRL3_C");
        ...
        {
            WhoAmI = 0x0F,
            Ctrl1Xl = 0x10, Ctrl2G = 0x11, Ctrl3C = 0x12,
